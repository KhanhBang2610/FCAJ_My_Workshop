---
title: "3.3. Tự động số hóa hồ sơ bệnh án với Amazon Bedrock Data Automation và AWS HealthLake"
weight: 3
---
...
- Người dùng upload hồ sơ bệnh án (PDF hoặc hình ảnh) lên Amazon S3.
- AWS Lambda nhận sự kiện upload và khởi động pipeline.
- Amazon Bedrock Data Automation phân tích tài liệu, tự động trích xuất các thông tin quan trọng như:
  - Thông tin bệnh nhân
  - Chẩn đoán
  - Kết quả xét nghiệm
  - Đơn thuốc
...
Dữ liệu sau đó được chuyển sang chuẩn FHIR R4.
AWS HealthLake lưu trữ và lập chỉ mục để các hệ thống y tế có thể truy vấn thông qua API tiêu chuẩn.

![Sơ đồ kiến trúc tự động số hóa](/images/healthlake-architecture.jpg)
