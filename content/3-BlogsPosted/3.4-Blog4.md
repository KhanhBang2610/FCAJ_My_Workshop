---
title: "3.4. Deep Dive vào AWS Bedrock & Vector Embedding - Cái gì biến văn bản thô thành “Tọa độ” cho AI?"
weight: 4
---
...
![Luồng chạy hệ thống](/images/blog4-workflow.jpg)
...
Chúng ta phải dùng code tách tài liệu ra thành từng đoạn nhỏ (chunk) khoảng vài ba câu hoặc 1 đoạn văn. Việc cắt nhỏ này giúp AI sau này tìm kiếm thông tin chính xác hơn thay vì bị loãng ngữ cảnh.
...
Đây là phần thú vị nhất của kiến trúc RAG. Khi người dùng gõ vào khung chat: "Tôi muốn bộ đồ ABCXYZ". Hệ thống sẽ làm các bước sau:
1. Gửi câu hỏi này lên Bedrock để biến nó thành một Vector (tạo ra một tọa độ mới trên bản đồ).
2. Cầm tọa độ này, đi vào Vector Database và chạy một thuật toán gọi là **Cosine Similarity** (đo góc giữa hai vector, chứ không phải đo khoảng cách thẳng thông thường).
3. Nói theo ngôn ngữ bình dân: Database sẽ dùng thước đo góc để xem trên bản đồ hàng ngàn chiều đó, những tài liệu nào nằm ở gần tọa độ của câu hỏi nhất.
4. Lấy ra top 5 kết quả gần nhất (chính là những đoạn text nói về áo cộc tay, quần đùi) và đẩy đống text đó cho mô hình ngôn ngữ lớn (LLM) để nó tổng hợp lại thành câu trả lời tự nhiên nhất.
