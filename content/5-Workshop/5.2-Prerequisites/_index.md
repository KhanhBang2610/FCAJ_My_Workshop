...
2. Tạo nhóm quản trị viên (Admin):
   ...
   ![Create Admin Group](/FCAJ_My_Workshop/images/5-Workshop/5.2-Prerequisites/iam_group_admin.png)
...
3. Tạo nhóm lập trình viên (Dev - cho các thành viên cần deploy nhưng không có quyền xóa các tài nguyên lõi):
   ...
   ![Create Dev Group](/FCAJ_My_Workshop/images/5-Workshop/5.2-Prerequisites/iam_group_dev.png)

4. Vào **IAM > Users > Create user**, tạo tài khoản cho các thành viên (ví dụ: `cf-vy`, `cf-luan`) và đưa họ vào các group tương ứng.

   ![Assign Users](/FCAJ_My_Workshop/images/5-Workshop/5.2-Prerequisites/iam_assign_users.png)
...
3. Đặt tên là `ecsTaskExecutionRole` và bấm Create.
   ...
   ![ECS Execution Role](/FCAJ_My_Workshop/images/5-Workshop/5.2-Prerequisites/iam_ecs_execution_role.png)
...
![ECS Backend Role](/FCAJ_My_Workshop/images/5-Workshop/5.2-Prerequisites/iam_ecs_backend_role.png)
...
![ECS Worker Role](/FCAJ_My_Workshop/images/5-Workshop/5.2-Prerequisites/iam_ecs_worker_role.png)
...
![Final IAM Roles](/FCAJ_My_Workshop/images/5-Workshop/5.2-Prerequisites/iam_final_roles.png)
...
```
![AWS CLI Config](/FCAJ_My_Workshop/images/5-Workshop/5.2-Prerequisites/aws_cli_config.png)
...
![Bedrock Model Access Auto](/FCAJ_My_Workshop/images/5-Workshop/5.2-Prerequisites/bedrock_access_retired.png)
