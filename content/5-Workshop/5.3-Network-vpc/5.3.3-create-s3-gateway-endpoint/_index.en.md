...
3. Ensure the **Status** column displays in green as **Available**.
   ...
   ![S3 Endpoint Verification](/FCAJ_My_Workshop/images/5-Workshop/5.3-Network-vpc/5.3.3-create-s3-gateway-endpoint/s3_endpoint_verify.png)
...
2. On the **Routes** tab, observe the routing rule running parallel to the NAT Gateway:
   ...
   ![S3 Endpoint Routes Private](/FCAJ_My_Workshop/images/5-Workshop/5.3-Network-vpc/5.3.3-create-s3-gateway-endpoint/s3_endpoint_routes_private.png)
...
2. On the **Routes** tab, you will also see the rule pointing the `pl-6fa54006` IP range to `vpce-xxxxxx`, appearing independently of the Internet Gateway (`igw-xxxx`).
   ...
   ![S3 Endpoint Routes Public](/FCAJ_My_Workshop/images/5-Workshop/5.3-Network-vpc/5.3.3-create-s3-gateway-endpoint/s3_endpoint_routes_public.png)
