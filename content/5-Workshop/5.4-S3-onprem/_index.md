...
- [Validate the Cognito User Pool](5.4.1-prepare/)
- [Validate the AppSync GraphQL API](5.4.2-create-interface-enpoint/)
- [Validate Lambda functions](5.4.3-test-endpoint/)
- [Validate CloudWatch logs](5.4.4-dns-simulation/)
