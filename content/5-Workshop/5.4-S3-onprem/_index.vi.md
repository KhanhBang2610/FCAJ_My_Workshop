...
- [Kiểm tra Cognito User Pool](5.4.1-prepare/)
- [Kiểm tra AppSync GraphQL API](5.4.2-create-interface-enpoint/)
- [Kiểm tra Lambda functions](5.4.3-test-endpoint/)
- [Kiểm tra CloudWatch logs](5.4.4-dns-simulation/)
