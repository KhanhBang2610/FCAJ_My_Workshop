...
![WAF Rules Created](/FCAJ_My_Workshop/images/5-Workshop/5.5-Security-setup/5.5.3-waf-rules/waf_rules_created.png)
...
**Bước tiếp theo:** Hệ thống Smart Media Analytics hiện đã được triển khai các lớp bảo mật nền tảng (Cognito, Secrets Manager, AWS WAF), đáp ứng tiêu chuẩn an toàn cốt lõi. Hãy sẵn sàng bước sang [**Chương 5.6: Ingestion Workflow**](../../5.6-Ingestion-workflow/) để bắt đầu thiết lập kiến trúc điều phối sự kiện bất đồng bộ!
